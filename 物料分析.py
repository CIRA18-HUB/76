...
def create_chart_container(chart_figure, title, description, tips, insight_text=None):
    ...
    # 显示解释和提示（放在图表下方）
    st.markdown(f"""
    <div style="background-color: #f8f9fe; border-radius: 10px; padding: 15px; margin-top: 15px; border: 1px solid #e2e8f0; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 15px;">
            <div>
                <h5 style="color: #1f3867; font-size: 1rem; margin-bottom: 10px; border-bottom: 1px solid #e2e8f0; padding-bottom: 6px; display: flex; align-items: center;">
                ...
                <p style="font-size: 0.9rem; margin-bottom: 0; color: #4a5568; line-height: 1.4; word-wrap: break-word; word-break: break-word;">{safe_description}</p>
            </div>
            ...
            <div>
                ...
                <ul style="padding-left: 15px; margin-bottom: 0; list-style-type: '→ ';">
    """, unsafe_allow_html=True)

    for tip in safe_tips:
        st.markdown(f"""
        <li style="font-size: 0.85rem; margin-bottom: 6px; color: #4a5568; line-height: 1.3;">{tip}</li>
        """, unsafe_allow_html=True)
    ...
    if safe_insight_text:
        st.markdown(f"""
        <div style="margin-top: 12px; background-color: rgba(45, 206, 137, 0.1); border-left: 4px solid #2dce89; padding: 12px; border-radius: 6px;">
            ...
            <p style="margin: 0; font-size: 0.9rem; color: #2d3748; line-height: 1.4;">{safe_insight_text}</p>
        </div>
        """, unsafe_allow_html=True)
