...
def main():
        ...
        with tab2:
            ...
            if len(material_sales_relation) > 0:
                ...
                # 计算气泡大小的缩放因子，确保视觉效果适当
                size_scale = material_sales_relation['ROI'].clip(0.1, 10) * 5
                ...
                fig.update_layout(
                    ...
                    legend=dict(
                        title=dict(text="客户价值分层", font=dict(size=13, color="#333")),
                        orientation="h",
                        y=-0.15,
                        x=0.5,
                        xanchor="center",
            ...
            <div class="chart-explanation">
                ...
                理想情况下，点应位于绿色线上方，表示投入产出比优秀。鼠标悬停可查看详细数据。</p>
            </div>
            ''', unsafe_allow_html=True)
