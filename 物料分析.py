        ...
        with tab3:
                ...
                if len(top_roi_distributors) > 0:
                    ...
                    for i, (_, distributor) in enumerate(top_roi_distributors.iterrows()):
                        ...
                        # 增加卡片宽度，确保内容不被截断
                        st.markdown(f'''
                        <div style="flex: 1; background-color: white; border-radius: 12px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08); padding: 20px; min-height: 180px; margin-bottom: 16px; overflow-wrap: break-word;">
